export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 mt-16">
           ...
           <div className="space-y-4">
             ...
             <div className="space-y-3">
               <div className="flex items-center space-x-3">
                 <i className="fas fa-user text-blue-600 dark:text-blue-400 w-4 h-4"></i>
                 <span className="text-gray-700 dark:text-gray-300">Telugu Renuka</span>
               </div>
               <div className="flex items-center space-x-3">
                 <i className="fas fa-envelope text-blue-600 dark:text-blue-400 w-4 h-4"></i>
                 <a 
               ...
               <div className="flex items-center space-x-3">
                 <i className="fas fa-code text-blue-600 dark:text-blue-400 w-4 h-4"></i>
                 <span className="text-gray-700 dark:text-gray-300">Full Stack Developer</span>
                     ...
                     {/* Tech Stack Section */}
           <div className="space-y-4">
             <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Built With</h3>
         ...
         <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8">
           <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
             <div className="text-gray-600 dark:text-gray-400 text-sm">
               © 2025 Telugu Renuka. All rights reserved.
             </div>
